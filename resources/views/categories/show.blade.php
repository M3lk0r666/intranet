    ...
    <div class="mt-4 bg-white rounded-lg shadow p-6">
        <div class="container mx-auto px-4 mt-20">
            <section class="text-center py-16 px-4 bg-gradient-to-b from-gray-50 to-white">
                ...
                <!-- Nombre categoría -->
                <p class="mt-6 text-4xl sm:text-5xl md:text-6xl font-black text-primary uppercase">
                    {{ $category->name }}
                </p>
                ...
                @forelse($posts as $post)
                    <article
                        ...
                        <div class="p-6">
                            <!-- Categoría -->
                            <span
                                class="inline-block px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded-full mb-4">
                                {{ $category->name }}
                            </span>
                            ...
                            <a href="{{ route('posts.show', $post) }}">
                                <h2
                                    class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 transition-colors duration-300 group-hover:text-primary">
                                    {{ $post->title }}
                                </h2>
                            </a>
