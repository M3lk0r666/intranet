        ...
        <section class="proc-hero p-6 md:p-9 mb-10 proc-anim-up">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div class="proc-stat">
                    ...
                    <div>
                        <div class="num">4</div>
                        <div class="label">Backgrouds para conferencias</div>
                    </div>
                </div>
                <div class="proc-stat">
                    ...
                    <div>
                        <div class="num">2</div>
                        <div class="label">Templates Presentaciones</div>
                    </div>
                </div>
                <div class="proc-stat">
                    ...
                    <div>
                        <div class="num">2</div>
                        <div class="label">Templates Documentos</div>
                    </div>
                </div>
                <div class="proc-stat">
            ...
            <div class="space-y-20">
                ...
                <section id="backgrounds">
                    <div class="flex items-end justify-between mb-8">
                        <div>
                            <h2 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Backgrounds para conferencias
                            </h2>
                            <p class="text-slate-500 dark:text-slate-400">Fondos virtuales de alta resolución para reuniones
                                y
                                eventos.</p>
                        </div>
                    </div>
                ...
                <section id="templates">
                    <div class="flex items-end justify-between mb-8">
                        <div>
                            <h2 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Templates para Presentaciones
                                y
                                Documentos</h2>
                            <p class="text-slate-500 dark:text-slate-400">Presentaciones estandarizadas para reuniones
                                internas
                                y externas.</p>
                        </div>
                    </div>
                            ...
                            <div class="p-6 flex flex-col gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1">
                                        Colección de iconos de infraestructura y red listos para presentaciones, dashboards
                                        o
                ...
                <section id="signatures">
                    ...
                    <div class="grid grid-cols-1 gap-8">
                        <!-- Signature Card -->
                        <div
                            class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                            <!-- Firma -->
