<!-- Artículos Similares (Card a la derecha) -->
<div class="lg:w-1/3 mt-8 lg:mt-0">
    <div class="bg-white shadow-lg rounded-xl p-6">
        <h2 class="text-xl font-semibold mb-4">Artículos Similares</h2>
        <ul class="space-y-4">


            <a href="#"
                class="flex flex-col items-center bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                <img class="object-cover w-full rounded-base h-64 md:h-auto md:w-48 mb-4 md:mb-0"
                    src="/docs/images/blog/image-4.jpg" alt="">
                <div class="flex flex-col justify-between md:p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-heading">Streamlining your design
                        process today.</h5>
                    <p class="mb-6 text-body">In todays fast-paced digital landscape, fostering seamless
            ...
            <!-- Iterar sobre los artículos similares -->
            {{-- @foreach ($similarPosts as $similarPost)
                <li>
                    <a href="{{ route('posts.show', $similarPost->id) }}"
